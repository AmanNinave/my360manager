...
export const addTransaction = async (req, res) => {
    try {
        const { type, source, remark, debit, credit, mode , moneyTransferAamount } = req.body;
...
export const editTransaction = async (req, res) => {
    try {
        ...
        const { type, source, remark, debit, credit, mode , moneyTransferAamount } = req.body; // Get updated values from the request body

        // Find and update the transaction
        const updatedTransaction = await Transaction.findByIdAndUpdate(
            transactionId,
            { type, source, remark, debit, credit, mode , moneyTransferAamount},
